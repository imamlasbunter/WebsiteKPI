...
using Pertamina.Website_KPI.Infrastructure.Persistence.SqlServer.Constants;
using Pertamina.Website_KPI.Shared.Audits.Constants;

namespace Pertamina.Website_KPI.Infrastructure.Persistence.SqlServer.Configuration;
public class AuditConfiguration : IEntityTypeConfiguration<Audit>
{
    public void Configure(EntityTypeBuilder<Audit> builder)
    {
        builder.ToTable(nameof(IWebsite_KPIDbContext.Audits), nameof(Website_KPI));
